<%-- 
    Document   : index
    Created on : Sep 16, 2022, 5:40:54 AM
    Author     : Akthar aki
--%>
...
<html lang="en">
   ...
   <body class="main-layout">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="header_information">
                           <ul>
                              <li><img src="images/1.png" alt="#"/> GoCheeta,Colombo</li>
                              <li><img src="images/2.png" alt="#"/> +94  755809737</li>
                              <li><img src="images/3.png" alt="#"/> aabith619@gmail.com</li>
                           </ul>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="limit-box">
                           <nav class="main-menu">
                              <ul class="menu-area-main">
                                 ...
                                 <li><a href="register.jsp">UserLogin</a></li>   
                              </ul>
                           </nav>
                        </div>
      ...
      <section >
         <div class="banner-main mt-5 mb-5">
            <img src="images/banner.jpg" alt="#"/>
            <div class="container">
               <div class="text-bg">
                  <h1>Online <br><strong class="white">Cab Service</strong></h1>
                  <div class="button_section"> <a class="main_bt" href="#about">get to Know About GoCheeta</a>  </div>
                  <div class="container">
      ...
      <div id="about" class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12 ">
                  <div class="titlepage">
                     <h2>About  our GoCheeta</h2>
                     <span> GoCheeta is a professional taxi service in Sri Lanka which provides an excellent, 24/7 service. We are one of the best, reliable and affordable taxi services in the country. Over 4000 vehicles, including cars, vans, buses, lorries and wedding cars are available with Flex Tours islandwide. Punctuality and the safety of our customers is guaranteed with Flex Tours.</span>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                     <div class="about-box">
                        <p> <span>GoCheeta is a professional taxi service in Sri Lanka which provides an excellent, 24/7 service. We are one of the best, reliable and affordable taxi services in the country. Over 4000 vehicles, including cars, vans, buses, lorries and wedding cars are available with Flex Tours islandwide. Punctuality and the safety of our customers is guaranteed with Flex Tours.</span></p>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="owl-carousel owl-theme">
                        <div class="item">
                           <img class="img-responsive" src="images/card (1).jpg" alt="#" />
                           <h3>Holiday Tour</h3>
                        ...
                        <div class="item">
                           <img class="img-responsive" src="images/card (2).jpg" alt="#" />
                           <h3>New York</h3>
                           <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in soe suffk even slightly believable. If y be sure there</p>
                        </div>
                        <div class="item">
                           <img class="img-responsive" src="images/card (3).jpg" alt="#" />
                           <h3>London</h3>
                           <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in soe suffk even slightly believable. If y be sure there</p>
                        </div>
                        <div class="item">
